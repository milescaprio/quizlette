...
questions.append(Question.MCQ("Ammonium"      ,  "NH4+1"       ,  ["NH4-1"], answer_count=2))
questions.append(Question.MCQ("Hydronium"     ,  "H3O+1"       ,  ["H3O-1", "OH-1", "OH+1"]))
questions.append(Question.MCQ("Hydroxide"     ,  "OH-1"        ,  ["OH+1", "H3O+1", "H3O-1"]))
questions.append(Question.MCQ("Nitrate"       ,  "NO3-1"       ,  ["NO3+1", "NO3-2", "NO3+2"]))
questions.append(Question.MCQ("Nitrite"       ,  "NO2-1"       ,  ["NO2+1", "NO2-2", "NO2+2"]))
questions.append(Question.MCQ("Sulfate"       ,  "SO4-2"       ,  ["SO4+1", "SO4-1", "SO4+2"]))
questions.append(Question.MCQ("Sulfite"       ,  "SO3-2"       ,  ["SO3+1", "SO3-1", "SO3+2"]))
questions.append(Question.MCQ("Phosphate"     ,  "PO4-3"       ,  ["PO4+1", "PO4-1", "PO4+2"]))
questions.append(Question.MCQ("Phosphite"     ,  "PO3-3"       ,  ["PO3+1", "PO3-1", "PO3+2"]))
questions.append(Question.MCQ("Carbonate"     ,  "CO3-2"       ,  ["CO3+1", "CO3-1", "CO3+2"]))
questions.append(Question.MCQ("BiCarbonate"   ,  "HCO3-1"      ,  ["HCO3+1", "HCO3-2", "HCO3+2"]))
questions.append(Question.MCQ("Cyanide"       ,  "CN-1"        ,  ["CN+1", "CN-2", "CN+2"]))
questions.append(Question.MCQ("Permanganate"  ,  "MnO4-1"      ,  ["MnO4+1", "MnO4-2", "MnO4+2"]))
questions.append(Question.MCQ("Acetate"       ,  "C2H3O2-1"    ,  ["C2H3O2+1", "C2H3O2-2", "C2H3O2+2"]))
questions.append(Question.MCQ("Peroxide"      ,  "O2-2"        ,  ["O2+1", "O2-1", "O2+2"]))

questions.append(Question.FRQ("NH4+1"     , "ammonium"         , filtered_equals(nest(stripped, lowercased))))
questions.append(Question.FRQ("H3O+1"     , "hydronium"        , filtered_equals(nest(stripped, lowercased))))
questions.append(Question.FRQ("OH-1"      , "hydroxide"        , filtered_equals(nest(stripped, lowercased))))
questions.append(Question.FRQ("NO3-1"     , "nitrate"          , filtered_equals(nest(stripped, lowercased))))
questions.append(Question.FRQ("NO2-1"     , "nitrite"          , filtered_equals(nest(stripped, lowercased))))
questions.append(Question.FRQ("SO4-2"     , "sulfate"          , filtered_equals(nest(stripped, lowercased))))
questions.append(Question.FRQ("SO3-2"     , "sulfite"          , filtered_equals(nest(stripped, lowercased))))
questions.append(Question.FRQ("PO4-3"     , "phosphate"        , filtered_equals(nest(stripped, lowercased))))
questions.append(Question.FRQ("PO3-3"     , "phosphite"        , filtered_equals(nest(stripped, lowercased))))
questions.append(Question.FRQ("CO3-2"     , "carbonate"        , filtered_equals(nest(stripped, lowercased))))
questions.append(Question.FRQ("HCO3-1"    , "bicarbonate"      , filtered_equals(nest(stripped, lowercased))))
questions.append(Question.FRQ("CN-1"      , "cyanide"          , filtered_equals(nest(stripped, lowercased))))
questions.append(Question.FRQ("MnO4-1"    , "permanganate"     , filtered_equals(nest(stripped, lowercased))))
questions.append(Question.FRQ("C2H3O2-1"  , "acetate"          , filtered_equals(nest(stripped, lowercased))))
questions.append(Question.FRQ("O2-2"      , "peroxide"         , filtered_equals(nest(stripped, lowercased))))
